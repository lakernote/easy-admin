...
public class HttpBinClient2 {
    ...
    public HttpBinClient2(RestClient.Builder restClientBuilder) {
        ...
        ClientHttpRequestFactory requestFactory = ClientHttpRequestFactories.get(HttpComponentsClientHttpRequestFactory.class, settings);
