...
public class DemoController {
    ...
    @EasyRateLimit(key = "pageList", timeWindow = 1, limit = 2, message = "请求过于频繁，请稍后再试")
    ...
    @EasyRateLimit(key = "paramEnum", timeWindow = 1, timeUnit = TimeUnit.DAYS, limit = 2, message = "一天只能请求两次")
