 ...
 * @since 2024-04-03
 */
@Api(tags = "示例-△△△Spring boot actuator示例△△△")
@ApiSupport(order = -1)
@Controller
...
public class ActuatorController {
     ...
     */
    @GetMapping("/health")
    @ApiOperation(value = "查看当前SpringBoot运行的健康指标，由HealthIndicator的实现类提供")
    public String health() {
        return "redirect:http://localhost:8080/actuator/health";
    }

    @GetMapping("/health/ping")
    @ApiOperation(value = "http://localhost:8080/actuator/health/ping")
     ...
     *
     * @see com.laker.admin.framework.ext.actuator.EasyAdminInfo
     */
    @GetMapping("/info")
    @ApiOperation(value = "查看服务版本,Git信息,properties中info开头的属性")
    public String info() {
        return "redirect:http://localhost:8080/actuator/info";
    }

    @GetMapping("/jar-version")
    @ApiOperation(value = "拓展，新增项目中依赖jar包版本查看功能")
