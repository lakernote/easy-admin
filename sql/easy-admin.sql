...
) ENGINE = InnoDB AUTO_INCREMENT = 8500 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '日志' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 297 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统菜单权限资源表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of sys_power
-- ----------------------------
INSERT INTO `sys_power` VALUES (1, 0, '工作空间', 'layui-icon layui-icon-cellphone', '', '', 0, 1, NULL, NULL, 0, '', NULL);
INSERT INTO `sys_power` VALUES (251, 0, '系统管理', 'layui-icon layui-icon-set-fill', '', '', 0, 1, NULL, NULL, 0, NULL, NULL);
INSERT INTO `sys_power` VALUES (252, 251, '权限管理', 'layui-icon layui-icon layui-icon layui-icon-face-cry', 'view/system/power.html', '_iframe', 2, 1, NULL, NULL, 1, '', NULL);
INSERT INTO `sys_power` VALUES (258, 251, '用户管理', 'layui-icon layui-icon-user', 'view/system/user.html', '_iframe', 1, 1, NULL, NULL, 1, 'user', NULL);
INSERT INTO `sys_power` VALUES (261, 260, '多选下拉', 'layui-icon ', 'view/document/select.html', '_iframe', 2, 1, NULL, NULL, 1, '', NULL);
INSERT INTO `sys_power` VALUES (263, 262, '数据表格', 'layui-icon ', 'view/document/table.html', '_iframe', 2, 1, NULL, NULL, 1, '', NULL);
INSERT INTO `sys_power` VALUES (264, 251, '流程定义', 'layui-icon layui-icon layui-icon-tree', 'view/flow/processList.html', '_iframe', 6, 1, NULL, NULL, 1, '', NULL);
INSERT INTO `sys_power` VALUES (265, 251, '流程实例', 'layui-icon ', 'view/flow/orderList.html', '', 9, 1, NULL, NULL, 1, '', NULL);
INSERT INTO `sys_power` VALUES (266, 251, '应用监控', 'layui-icon layui-icon layui-icon layui-icon layui-icon layui-icon layui-icon-auz', 'http://101.132.189.23:81/monitoring', '_iframe', 10, 1, NULL, NULL, 1, '', NULL);
INSERT INTO `sys_power` VALUES (268, 251, '接口文档', 'layui-icon layui-icon layui-icon layui-icon layui-icon layui-icon ', 'http://101.132.189.23:81/doc.html', '_iframe', 5, 1, NULL, NULL, 1, '', NULL);
INSERT INTO `sys_power` VALUES (269, 1, '任务列表', 'layui-icon ', 'view/flow/taskList.html', '_iframe', 1, 1, NULL, NULL, 1, '', NULL);
INSERT INTO `sys_power` VALUES (270, 1, '请假申请', 'layui-icon layui-icon ', 'view/ext/leave.html', '_iframe', 4, 1, NULL, NULL, 1, '', NULL);
INSERT INTO `sys_power` VALUES (280, 251, '角色管理', 'layui-icon layui-icon ', 'view/system/role.html', '_iframe', 3, 1, NULL, NULL, 1, '', NULL);
INSERT INTO `sys_power` VALUES (281, 251, '部门管理', 'layui-icon layui-icon ', 'view/system/deptment.html', '_iframe', 4, 1, NULL, NULL, 1, '', NULL);
INSERT INTO `sys_power` VALUES (282, 1, '配套专栏', 'layui-icon layui-icon layui-icon layui-icon ', 'https://blog.csdn.net/abu935009066/category_10817814.html', '_iframe', 3, 1, NULL, NULL, 1, '', NULL);
INSERT INTO `sys_power` VALUES (283, 251, 'WebLog', 'layui-icon ', 'view/system/weblog.html', '_iframe', 12, 1, NULL, NULL, 1, '', NULL);
INSERT INTO `sys_power` VALUES (284, 251, '字典管理', 'layui-icon layui-icon ', 'view/system/dict.html', '_iframe', 13, 1, NULL, NULL, 1, '', NULL);
INSERT INTO `sys_power` VALUES (285, 1, '日志查看', 'layui-icon layui-icon layui-icon ', 'view/ext/log.html', '_iframe', 6, 1, NULL, NULL, 1, '', NULL);
INSERT INTO `sys_power` VALUES (286, 258, '查询', 'layui-icon ', '', '', 1, 0, NULL, NULL, 2, 'user-seach', NULL);
INSERT INTO `sys_power` VALUES (287, 1, '定时任务', 'layui-icon ', 'view/system/task.html', '_iframe', 7, 1, NULL, NULL, 1, '', NULL);
INSERT INTO `sys_power` VALUES (288, 285, '日志查看', 'layui-icon ', '', '', 1, 1, NULL, NULL, 2, 'log.list', NULL);
INSERT INTO `sys_power` VALUES (289, 0, '源码下载', 'layui-icon layui-icon-praise', '', '', 1, 1, NULL, NULL, 0, '', NULL);
INSERT INTO `sys_power` VALUES (290, 289, '码云地址', 'layui-icon layui-icon ', 'https://gitee.com/lakernote/easy-admin', '_blank', 1, 1, NULL, NULL, 1, '', NULL);
INSERT INTO `sys_power` VALUES (291, 1, '在线用户', 'layui-icon ', 'view/system/onlineUser.html', '_iframe', 7, 1, NULL, NULL, 1, '', NULL);
INSERT INTO `sys_power` VALUES (292, 1, 'NginxUI', 'layui-icon ', 'view/system/nginx.html', '_iframe', 1, 1, NULL, NULL, 1, '', NULL);
INSERT INTO `sys_power` VALUES (293, 283, '查看', 'layui-icon ', '', '', 1, 1, NULL, NULL, 2, 'weblog.list', NULL);
...
INSERT INTO `sys_role` VALUES (11, '数据角色普通', '', '', 1, NULL, 2);
...
INSERT INTO `sys_role_power` VALUES (222, 5, 1);
INSERT INTO `sys_role_power` VALUES (223, 5, 269);
INSERT INTO `sys_role_power` VALUES (224, 5, 270);
INSERT INTO `sys_role_power` VALUES (225, 5, 282);
INSERT INTO `sys_role_power` VALUES (226, 5, 285);
INSERT INTO `sys_role_power` VALUES (227, 5, 288);
INSERT INTO `sys_role_power` VALUES (228, 5, 287);
INSERT INTO `sys_role_power` VALUES (229, 5, 291);
INSERT INTO `sys_role_power` VALUES (230, 5, 251);
INSERT INTO `sys_role_power` VALUES (231, 5, 252);
INSERT INTO `sys_role_power` VALUES (232, 5, 258);
INSERT INTO `sys_role_power` VALUES (233, 5, 286);
INSERT INTO `sys_role_power` VALUES (234, 5, 264);
INSERT INTO `sys_role_power` VALUES (235, 5, 265);
INSERT INTO `sys_role_power` VALUES (236, 5, 266);
INSERT INTO `sys_role_power` VALUES (237, 5, 268);
INSERT INTO `sys_role_power` VALUES (238, 5, 280);
INSERT INTO `sys_role_power` VALUES (239, 5, 281);
INSERT INTO `sys_role_power` VALUES (240, 5, 283);
INSERT INTO `sys_role_power` VALUES (241, 5, 284);
INSERT INTO `sys_role_power` VALUES (242, 5, 259);
INSERT INTO `sys_role_power` VALUES (243, 5, 260);
INSERT INTO `sys_role_power` VALUES (244, 5, 262);
INSERT INTO `sys_role_power` VALUES (245, 5, 289);
INSERT INTO `sys_role_power` VALUES (246, 5, 290);
...
INSERT INTO `sys_user_role` VALUES (73, 16, 5);
INSERT INTO `sys_user_role` VALUES (74, 16, 10);
